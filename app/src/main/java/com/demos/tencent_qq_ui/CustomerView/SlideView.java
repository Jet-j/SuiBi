...
public class SlideView extends HorizontalScrollView implements View.OnClickListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mSlideMenu = (ImageView) mainView.findViewById(R.id.slide_menu);
...
//        ViewHelper.setScaleY(mainView, rightScale);
        ...
        //主界面的头像
        ViewHelper.setAlpha(mainView.findViewById(R.id.slide_menu), scale);
        ViewHelper.setTranslationX(mainView.findViewById(R.id.slide_menu), 1 - scale);
